...
from thirdparty.crnn_ctc_model import ctc_infer, ctc_train_net
import numpy as np
...
add_arg('model_path',         str,  "work/thirdparty/enchance2/model_15000",   "The model path to be used for inference.")
add_arg('input_images_dir',   str,  "work/test_images",   "The directory of images.")
add_arg('input_images_list',  str,  "work/test.txt",   "The list file of images.")
