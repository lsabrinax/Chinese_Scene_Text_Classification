...
add_arg('save_model_dir',    str,   "work/thirdparty/enchance2", "The directory the model to be saved to.")
add_arg('model',    str,   "crnn_ctc",           "Which type of network to be used. 'crnn_ctc' or 'attention'")
add_arg('train_images',      str, "work/train_images/", "train image dir")
add_arg('train_list',        str, "work/train.list",   "train image list")
add_arg('test_images',       str, "work/train_images/",  "test image dir")
add_arg('test_list',         str, "work/test.list",    "test image list")
add_arg('init_model',        str,   "work/thirdparty/enchance/",       "The init model file of directory.")
